...
[![CCM50NodeRED](/assets/img/CCM50NodeRed.png)](/assets/img/CCM50NodeRed.png)
...
[![Ambient](/assets/img/Ambient_read-flow.png)](/assets/img/Ambient_read-flow.png)

When observing de debug output it shows the payload object with the humidity and temperature:

[![Payload object](/assets/img/PayloadObject.png)](/assets/img/PayloadObject.png)
...
[![ErrorModbusInstall](/assets/img/ErrorModbusInstall.png)](/assets/img/ErrorModbusInstall.png)
...
[![ModbusRead](/assets/img/ModbusRead.png)](/assets/img/ModbusRead.png)
...
[![ModbusClientConfig](/assets/img/ModbusClientNode.png)](/assets/img/ModbusClientNode.png)
...
[![Payload object](/assets/img/PayloadObjectModbus.png)](/assets/img/PayloadObjectModbus.png)
